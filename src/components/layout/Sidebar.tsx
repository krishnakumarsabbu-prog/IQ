...
import { Home, Plus, Mail, FileText, Smartphone, TestTube, Users, Shield, Key, ChevronLeft, ChevronRight, AlertTriangle, GitBranch, UserCheck, MessageSquare, Settings, Layers, ListChecks, Database, GitCommitVertical as GitCommit, History, FormInput, ChevronDown, ChevronUp, LayoutTemplate } from 'lucide-react';
      ...
      <nav className="flex-1 p-4 space-y-1.5 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-800">
        ...
        <div>
          ...
          >
            ...
            {!isCollapsed && (
              <>
                <span className="ml-3.5 truncate flex-1">Settings</span>
          ...
          {settingsExpanded && !isCollapsed && (
            <div className="ml-4 mt-1 space-y-1 border-l-2 border-slate-100 dark:border-slate-800 pl-3">
              ...
              >
                ...
                <span className="ml-3 truncate">General Settings</span>
              </NavLink>
              ...
              >
                ...
                <span className="ml-3 truncate">Document Layout Designer</span>
              </NavLink>
            </div>
          )}
